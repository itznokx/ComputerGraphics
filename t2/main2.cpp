...
int main (void){
	...
	float dJanela = 30.0f;
	Scene cena;
	Sphere s1 = Sphere(Vec3(0,0,-100.0f),rSphere,Vec4(0.7f, 0.0f, 0.0f,1.0f),10.0f);
	//Sphere s2 = Sphere(Vec3(50.0f,0,-100.0f),rSphere,Vec4(0.2f, 0.2f, 0.7f,1.0f),10.0f);
	Plane p1 = Plane(Vec3(0.0f,-rSphere,0.0f),Vec3(0.0f,1.0f,0.0f),Vec4(0.2f,0.7f,0.7f,1.0f),1.0f);
	Light l1 = Light(Vec3(0.0f,-80.0f,-60.0f),Vec4(1.0f, 1.0f, 1.0f,1.0f));
	cena.insertLight(&l1);
